...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR  :  IKHSAN  "$i"                    "
echo $i""$pu"  WhatsApp:  08128384xxxx"$i"                "
echo $i""$pu"  GMAIL   :  ikhsanadhisaputro2003@gmail.com"$i"     "
echo $pur"==================="$cy" ============================="
echo
...
sleep 2
echo $ku"Facebook :"$i" Ikhsan Adi"
echo $ku"WhatsApp :"$i" 08128384xxxx"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"Terimakasih :)"
exit
fi
